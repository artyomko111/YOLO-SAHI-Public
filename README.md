...
• In Table 8, the metrics Precision, Recall, mAP@50 for YOLOv9-E, YOLOv10-X, YOLOv11-X, YOLOv12-X, YOLOv9+C3k2_SHSA, YOLOv10+C2f_SHSA, YOLOv12+C3k_SHSA, and mAP@50-95 were obtained using the following command:<br>
